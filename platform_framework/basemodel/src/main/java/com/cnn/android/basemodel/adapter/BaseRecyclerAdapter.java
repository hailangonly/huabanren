...
import com.cnn.android.basemodel.adapter.animation.AlphaInAnimation;
import com.cnn.android.basemodel.adapter.animation.BaseAnimation;
import com.cnn.android.basemodel.adapter.animation.ScaleInAnimation;
import com.cnn.android.basemodel.adapter.animation.SlideInBottomAnimation;
import com.cnn.android.basemodel.adapter.animation.SlideInLeftAnimation;
import com.cnn.android.basemodel.adapter.animation.SlideInRightAnimation;
import com.cnn.android.basemodel.adapter.entity.IExpandable;
import com.cnn.android.basemodel.adapter.loadmore.LoadMoreView;
import com.cnn.android.basemodel.adapter.loadmore.SimpleLoadMoreView;
 ...
 */
public abstract class BaseRecyclerAdapter<T, K extends BaseViewHolder>
  ...
  public static final int EMPTY_VIEW_1 = 0x00000666;
  ...
  /**
   * @deprecated This method is because it can lead to crash: always call this method while
   ...
   * notice: Deprecated! Use {@link ViewGroup#getChildCount()} of {@link #getHeaderLayout()} to
   * replace.
   *
   * @return
   */
   ...
   * notice: Deprecated! Use {@link ViewGroup#getChildCount()} of {@link #getFooterLayout()} to
   * replace.
   *
   * @return
   */
  ...
  public K onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      ...
      case FOOTER_VIEW:
        ...
        break;
      case EMPTY_VIEW_1:
        baseViewHolder = createBaseViewHolder(null,twoLayoutId);
        break;
      default:
        baseViewHolder = onCreateDefViewHolder(null, viewType);
    }
   ...
   *
   * @param isHeadAndEmpty false will not show headView if the data is empty true will show
   *          emptyView and headView
   */
  ...
  /**
   * When the current adapter is empty, the BaseRecyclerAdapter can display a special view
   ...
   * @param parent Optional view to be the parent of the generated hierarchy or else simply an
   *          object that
  ...
  protected void convert(K helpe){};
   ...
   * @param shouldNotify notify the RecyclerView to rebind items, <strong>false</strong> if you want
   *          to do it
   *          yourself.
  ...
  public int getParentPosition(@NonNull T item) {
    ...
    // if the item is IExpandable, return a closest IExpandable item position whose level smaller
    // than this.
...
/*
  ...
  public static class ExtraItem<K extends RecyclerView.ViewHolder> {
    public final int type;
    public final K view;

    public ExtraItem(int type, K view) {
      this.type = type;
      this.view = view;
    }
  ...
  public ExtraItem getHeader(int mIntArgHeaderPos) {
    ...
    public ExtraItem addHeaderView(int type, K headerView) {
    ...
    public ExtraItem addFooterView(int type, K footerView) {
