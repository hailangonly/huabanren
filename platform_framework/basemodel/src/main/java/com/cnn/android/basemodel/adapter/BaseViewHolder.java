...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setImageResource(int viewId, String imageResId) {
        ImageView view = getView(viewId);
        Glide.with(view.getContext()).load(imageResId).centerCrop().into(view);
        return this;
    }
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setImageResource(int viewId, String imageResId,int errId) {
        ImageView view = getView(viewId);
        Glide.with(view.getContext()).load(imageResId).error(errId).centerCrop().into(view);
        return this;
    }
    /**
     * Will set the image of an ImageView from a resource id.
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setImageResource(int viewId, String imageResId,int w,int h) {
        ImageView view = getView(viewId);
        Glide.with(view.getContext()).load(imageResId).override(w,h).centerCrop().into(view);
        return this;
    }
    /**
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setOnClickListener(int viewId, View.OnClickListener listener,Object tag) {
        View view = getView(viewId);
        view.setTag(tag);
        view.setOnClickListener(listener);
        return this;
    ...
    public void setViewSize(int viewId) {
    }
}
