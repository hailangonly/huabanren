...
import com.lcodecore.tkrefreshlayout.header.progresslayout.RefreshRecyclerViewHeader;
...
public class TwinklingRefreshLayout extends RelativeLayout implements PullListener {
    ...
    private void addHeader() {
        ...
        if (mHeadView == null) setHeaderView(RefreshRecyclerViewHeader.newInstance(getContext()));
    }
